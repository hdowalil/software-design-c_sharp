...
namespace ContractAndAPI.Lab02.Excercise.Solution.Trainer
{
    class Battery
    {
        ...
        {
            Contract.Invariant(CapacityInAmpereHours > 0.0);
            Contract.Invariant(LevelOfAmpereHours >= 0.0);
            Contract.Invariant(LevelOfAmpereHours <= CapacityInAmpereHours);
        }
